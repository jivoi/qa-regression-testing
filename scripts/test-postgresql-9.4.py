#!/usr/bin/python
#
#    test-postgresql-9.4.py quality assurance test script
...
# QRT-Packages: sudo lsb-release postgresql-common libpq-dev procps language-pack-ru ssl-cert locales python-pygresql patch postgresql-9.4 postgresql-contrib-9.4 postgresql-plpython-9.4 postgresql-plperl-9.4 postgresql-pltcl-9.4 postgresql-server-dev-9.4 hunspell-en-us postgresql-plpython3-9.4 libecpg-dev
# QRT-Privilege: root
