#!/usr/bin/python
#
#    test-python3.4.py quality assurance test script
...
# QRT-Packages: python3.4 netcat-openbsd w3m

import subprocess
import sys

if __name__ == '__main__':
    print 'python3.4 regression tests'
    prc = subprocess.Popen([ 'python', 'test-python.py', 'python3.4'],
                    stdout=sys.stdout,
