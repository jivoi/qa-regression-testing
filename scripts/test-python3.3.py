#!/usr/bin/python
#
#    test-python3.3.py quality assurance test script
...
# QRT-Packages: python3.3 netcat-openbsd w3m

import subprocess
import sys

if __name__ == '__main__':
    print 'python3.3 regression tests'
    prc = subprocess.Popen([ 'python', 'test-python.py', 'python3.3'],
                    stdout=sys.stdout,
