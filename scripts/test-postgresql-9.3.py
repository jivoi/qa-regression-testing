#!/usr/bin/python
#
#    test-postgresql-9.3.py quality assurance test script
...
# QRT-Packages: sudo lsb-release postgresql-common libpq-dev procps language-pack-ru ssl-cert locales python-pygresql patch postgresql-9.3 postgresql-contrib-9.3 postgresql-plpython-9.3 postgresql-plperl-9.3 postgresql-pltcl-9.3 postgresql-server-dev-9.3 hunspell-en-us postgresql-plpython3-9.3 libecpg-dev
# QRT-Privilege: root
