#!/usr/bin/python
#
#    test-python2.7.py quality assurance test script
...
# QRT-Packages: python2.7 w3m netcat-openbsd

import subprocess
import sys

if __name__ == '__main__':
    print 'python2.7 regression tests'
    prc = subprocess.Popen([ 'python', 'test-python.py', 'python2.7'],
                    stdout=sys.stdout,
