...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <xsl:attribute-set name="properties">
   ...
   <xsl:attribute name="space-after.minimum">-11px</xsl:attribute>
   <xsl:attribute name="space-after.maximum">-9px</xsl:attribute>
 ...
 <xsl:template match="PARAGRAPH"> 
    ...
    <fo:block>
          This is a reference line for the property set above.
    </fo:block>
 </xsl:template>
</xsl:stylesheet>
