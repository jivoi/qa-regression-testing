...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <xsl:attribute-set name="properties">
   <xsl:attribute name="space-after.optimum">0.25px</xsl:attribute>
   <xsl:attribute name="space-after.minimum">0.24px</xsl:attribute>
   <xsl:attribute name="space-after.maximum">0.26px</xsl:attribute>
