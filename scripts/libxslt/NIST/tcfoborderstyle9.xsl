...
<xsl:output indent="yes"/>
 <xsl:attribute-set name = "parentProperties">  <xsl:attribute name = "border-before-style">solid</xsl:attribute>  <xsl:attribute name = "border-after-style">solid</xsl:attribute>  <xsl:attribute name = "border-start-style">solid</xsl:attribute>  <xsl:attribute name = "border-end-style">solid</xsl:attribute></xsl:attribute-set><xsl:attribute-set name = "foProperties1">  <xsl:attribute name = "column-width">1.0in</xsl:attribute></xsl:attribute-set><xsl:attribute-set name = "foProperties4">  <xsl:attribute name = "background-color">red</xsl:attribute>  <xsl:attribute name = "border-before-style">inherit</xsl:attribute>  <xsl:attribute name = "border-after-style">inherit</xsl:attribute>  <xsl:attribute name = "border-start-style">inherit</xsl:attribute>  <xsl:attribute name = "border-end-style">inherit</xsl:attribute></xsl:attribute-set>
