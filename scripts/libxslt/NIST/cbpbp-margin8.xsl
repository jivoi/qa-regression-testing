...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <xsl:attribute-set name="properties">
   ...
   <xsl:attribute name="space-after.minimum">0.99cm</xsl:attribute>
   <xsl:attribute name="space-after.maximum">1.01cm</xsl:attribute>
   ...
   <xsl:attribute name="space-before.minimum">0.99cm</xsl:attribute>
   <xsl:attribute name="space-before.maximum">1.01cm</xsl:attribute>
