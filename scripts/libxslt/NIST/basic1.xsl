    ...
    <fo:page-sequence master-name="test-page-master">
        <fo:flow flow-name="xsl-region-body">
                <fo:block
                    ...
                    <fo:block text-align="center">Child number 1</fo:block>
                    <fo:block text-align="center">Child number 2</fo:block>
                    <fo:block text-align="center">Child number 3</fo:block>
               </fo:block>
        </fo:flow>
    </fo:page-sequence>
  </fo:root>
