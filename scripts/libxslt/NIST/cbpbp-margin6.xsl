...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <xsl:attribute-set name="properties">
   ...
   <xsl:attribute name="space-after.minimum">4.9em</xsl:attribute>
   <xsl:attribute name="space-after.maximum">5.1em</xsl:attribute>
   ...
   <xsl:attribute name="space-before.minimum">4.9em</xsl:attribute>
   <xsl:attribute name="space-before.maximum">5.1em</xsl:attribute>
