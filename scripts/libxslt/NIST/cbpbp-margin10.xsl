...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <xsl:attribute-set name="properties">
   ...
   <xsl:attribute name="space-after.optimum">-10px</xsl:attribute>
   <xsl:attribute name="space-after.minimum">-10.1px</xsl:attribute>
   <xsl:attribute name="space-after.maximum">-9.9px</xsl:attribute>
   <xsl:attribute name="space-after.precedence">force</xsl:attribute>
   <xsl:attribute name="space-after.conditionality">retain</xsl:attribute>
   <xsl:attribute name="space-before.optimum">-10px</xsl:attribute>
   <xsl:attribute name="space-before.minimum">-10.1px</xsl:attribute>
   <xsl:attribute name="space-before.maximum">-9.9px</xsl:attribute>
