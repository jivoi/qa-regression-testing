...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <xsl:attribute-set name="properties">
   <xsl:attribute name="space-before.optimum">50mm</xsl:attribute>
   <xsl:attribute name="space-before.minimum">49mm</xsl:attribute>
   <xsl:attribute name="space-before.maximum">51mm</xsl:attribute>
