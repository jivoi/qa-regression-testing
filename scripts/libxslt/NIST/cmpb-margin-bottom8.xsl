...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <xsl:attribute-set name="properties">
   <xsl:attribute name="space-after.optimum">0px</xsl:attribute>
   <xsl:attribute name="space-after.minimum">0px</xsl:attribute>
   <xsl:attribute name="space-after.maximum">0px</xsl:attribute>
