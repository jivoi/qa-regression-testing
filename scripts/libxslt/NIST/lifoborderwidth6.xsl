...
<xsl:attribute-set name = "foProperties1">
  ...
  <xsl:attribute name = "border-before-width">inherit</xsl:attribute>
  <xsl:attribute name = "border-after-width">inherit</xsl:attribute>
  <xsl:attribute name = "border-start-width">inherit</xsl:attribute>
  <xsl:attribute name = "border-end-width">inherit</xsl:attribute>
  <xsl:attribute name = "border-before-style">solid</xsl:attribute>
  <xsl:attribute name = "border-after-style">solid</xsl:attribute>
  <xsl:attribute name = "border-start-style">solid</xsl:attribute>
  <xsl:attribute name = "border-end-style">solid</xsl:attribute>
