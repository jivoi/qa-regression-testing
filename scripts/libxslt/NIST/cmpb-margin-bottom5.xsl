...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <xsl:attribute-set name="properties">
   <xsl:attribute name="space-after.optimum">50mm</xsl:attribute>
   <xsl:attribute name="space-after.minimum">49mm</xsl:attribute>
   <xsl:attribute name="space-after.maximum">51mm</xsl:attribute>
