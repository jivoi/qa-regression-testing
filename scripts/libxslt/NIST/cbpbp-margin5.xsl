...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <xsl:attribute-set name="properties">
   ...
   <xsl:attribute name="space-after.minimum">2.9em</xsl:attribute>
   <xsl:attribute name="space-after.maximum">3.1em</xsl:attribute>
   ...
   <xsl:attribute name="space-before.minimum">2.9em</xsl:attribute>
   <xsl:attribute name="space-before.maximum">3.1em</xsl:attribute>
