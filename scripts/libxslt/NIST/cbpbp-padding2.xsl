...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <xsl:attribute-set name="properties">
   ...
   <xsl:attribute name="padding-right">0.5in</xsl:attribute>
   <xsl:attribute name="padding-bottom">0.5in</xsl:attribute>
   <xsl:attribute name="padding-top">0.5in</xsl:attribute>
