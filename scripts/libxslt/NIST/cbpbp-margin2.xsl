...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
 ...
 <xsl:attribute-set name="properties">
   ...
   <xsl:attribute name="space-after.optimum">0.5in</xsl:attribute>
   <xsl:attribute name="space-after.minimum">0.49in</xsl:attribute>
   <xsl:attribute name="space-after.maximum">0.51in</xsl:attribute>
   <xsl:attribute name="space-after.precedence">force</xsl:attribute>
   <xsl:attribute name="space-after.conditionality">retain</xsl:attribute>
   <xsl:attribute name="space-before.optimum">0.5in</xsl:attribute>
   <xsl:attribute name="space-before.minimum">0.49in</xsl:attribute>
   <xsl:attribute name="space-before.maximum">0.51in</xsl:attribute>
